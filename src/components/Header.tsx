        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link id="logo-link" to="/" className="flex items-center space-x-3.5 group">
            <div className="relative flex items-center justify-center">
              {/* Outer glowing ring */}
              <div className="absolute inset-0 bg-gradient-to-tr from-amber-400 to-amber-600 rounded-xl opacity-30 blur-[3px] group-hover:scale-110 group-active:scale-90 transition-transform duration-300" />
              {/* Inner container */}
              <div className="relative p-2.5 bg-gradient-to-br from-amber-400 via-amber-500 to-amber-600 rounded-xl text-[#0f2d59] shadow-inner transform group-hover:rotate-6 group-active:-rotate-12 group-active:scale-95 transition-all duration-300">
